...
## 🛠️ Technology Stack
>>>>>>> 480b7140199e8f93f00f4034c1a65eb1ed379161
...
3. **Open `.env` and add the following content**:
   ...
   **Note:** 
   - If you don't have a service role key, you can leave it empty (some features may be limited)
   - OpenAI API key is optional but required for recipe generation and receipt scanning features

### Step 5: Database Setup

The database schema is already set up on Supabase. If you need to set up a new database:

1. **Run the database schema** (in Supabase SQL Editor):

   - Open `data_scheme.sql` in your Supabase project
   - Execute the SQL script in the Supabase SQL Editor

2. **Run migrations** (if needed):

   - Check the `migrations/` directory for any additional setup scripts
   - Execute them in order in the Supabase SQL Editor
